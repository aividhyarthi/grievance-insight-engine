...
const conditions = [
  ...
  },
  {
    ...
    detail:
      "Around 1 in 3 women over 50 will sustain an osteoporotic fracture, and cardiovascular disease is the leading cause of death in women worldwide. Bone loss accelerates sharply around the final period — which is exactly when screening has the most value.",
