...
imageAlt: "Indian woman reviewing lab results on a tablet in a clinic waiting area, looking focused"
---
...
FSH is released by the pituitary gland to stimulate the ovaries to produce eggs. As the ovaries become less responsive during perimenopause, the pituitary produces *more* FSH in an attempt to compensate.
...
**When to test**: Day 2–5 of your menstrual cycle (counting day 1 as the first day of full flow). This is the "follicular phase" baseline.

### LH (Luteinising Hormone)

LH works alongside FSH to trigger ovulation. In perimenopause, LH levels also rise. Often tested alongside FSH for a fuller picture.
...
**Important caveat**: AMH tells you about egg quantity, not whether you ovulated this cycle. It does not confirm or rule out current symptoms.
...
Vitamin D deficiency is widespread in India and contributes to fatigue, mood changes, joint pain, and poor bone health. Given that perimenopause already accelerates bone loss, knowing your vitamin D status is important.
...
### Reading Indian Lab Reports

Indian diagnostic labs (Thyrocare, SRL, Apollo Diagnostics) use standard international reference ranges. However, reference ranges can vary between labs and are not always age-stratified.

For perimenopause-relevant tests, approximate Indian lab reference ranges to be aware of:

| Test | Typical Follicular Phase Range | Perimenopause Indicator |
|------|-------------------------------|------------------------|
...
Testing is genuinely affordable in India. Approximate costs at labs like Thyrocare, SRL, and Apollo Diagnostics:

- FSH + LH + Oestradiol: ₹800–1,500
- AMH: ₹1,200–2,000
- Thyroid panel (TSH + Free T3 + Free T4): ₹400–800
- Ferritin: ₹400–600
- Vitamin D: ₹700–1,200
- Vitamin B12: ₹400–700
...
### Home Menopause Test Kits from Pharmacies

Menopause test kits available at pharmacies (such as FSH urine strips) measure urinary FSH and give a yes/no result based on whether FSH is above a threshold.

These are unreliable for perimenopause because FSH fluctuates so much. You may test on a day when FSH happens to be within normal range and get a negative result, even if you are perimenopausal. Or you may get an elevated result on a day when FSH is spiking and not yet be perimenopausal. A strip result should never be used as the basis for either starting or avoiding treatment.
...
Tests are most useful when discussed with a clinician who is experienced in perimenopause. The challenge is that not all gynaecologists in India have kept pace with current guidance on perimenopause diagnosis and management.

When you see a gynaecologist for perimenopause:
- Come with a written list of your symptoms, including how long you've had them and how they affect your daily life
- Ask specifically whether perimenopause could be contributing
- Ask which tests they recommend and why
- Don't accept "your tests are normal, everything is fine" if your symptoms are significant

The Menopause Society of India (menopausesocietyindia.com) has a directory of member doctors who have received specific training in menopause management.
...
**The first step is understanding your own symptom picture. Our free 3-minute symptom check was built specifically for Indian women navigating this transition.**
